...
ArrayList<Car> list=(ArrayList<Car>)request.getAttribute("chooselist");
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_sear">
        <tr>
          ...
          <td><div class="sear_item">
              <ul>
                <li><span class="name_item">车型：</span>
                  <ul class="item_ul">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_list">
        	<%for(int i=0;i<list.size();i++){%>
		         ...
		         <td width="135"><%=list.get(i).getCid()%></td>
		            ...
		            <td align="right"><a href="rentNow.jsp?name=<%=userName%>&cid=<%=list.get(i).getCid()%>&zujin=<%=list.get(i).getXzujin()%>&yajin=<%=list.get(i).getXyajin()%>" class="green_a">租赁</a>&nbsp;
      ...
      <table cellspacing="0" cellpadding="0" border="0" width="100%"  >
        <tbody>
        	<%if(nowP==1){%>
	        	<tr>
	            <td>&nbsp;</td>
	            <td align="right"><ul class="page-nav">
	               <li> <a href="ChooseCarServlet?nowPage=1" class="arr_nexr">首页</a> </li>
	                <li> <a href="" class="arr_nexr">上页</a> </li>
	                <li> <a href="ChooseCarServlet?nowPage=<%=nowP+1%>" class="arr_nexr">下页</a> </li>
	                <li> <a href="ChooseCarServlet?nowPage=<%=totalPages%>" class="arr_nexr">尾页</a> </li>
	              </ul></td>
	          </tr>
        	<%}else if(nowP==totalPages){%>
	            ...
	            <td align="right"><ul class="page-nav">
	               <li> <a href="ChooseCarServlet?nowPage=1" class="arr_nexr">首页</a> </li>
	                <li> <a href="ChooseCarServlet?nowPage=<%=nowP-1%>" class="arr_nexr">上页</a> </li>
	                <li> <a href="" class="arr_nexr">下页</a> </li>
	                <li> <a href="ChooseCarServlet?nowPage=<%=totalPages%>" class="arr_nexr">尾页</a> </li>
	              </ul></td>
	          	</tr>
        	<%}else{%>
