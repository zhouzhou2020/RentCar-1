...
<body>
    ...
    <div class="tools">
        ...
        <ul class="toolbar1">
        <a href="carAdd.jsp"><li><span><img src="images/t05.png" /></span>添加汽车</li></a>
        </ul>
    ...
    <table class="tablelist">
        ...
        <%for(int i=0;i<list.size();i++){ %>
        	<tr>
        		...
        		<td><a href="carUpdate.jsp?id=<%=list.get(i).getCid() %>" class="tablelink">修改</a>  
        		    <a href="CarDelServlet?id=<%=list.get(i).getCid() %>" class="tablelink">删除</a></td>
        	</tr>
        <%}%>
        </tbody>
    ...
    <div class="pagin">
    	<%if(nowP==1){%>
    		<ul class="paginList">
	        <li class="paginItem"><a href="CarListServlet?nowPage=1">首页</a></li>
	        <li class="paginItem"><a href="">上页</a></li>
	        <li class="paginItem"><a href="CarListServlet?nowPage=<%=nowP+1%>">下页</a></li>
	        <li class="paginItem"><a href="CarListServlet?nowPage=<%=totalPages%>">尾页</a></li>
	        </ul>
    	<%}else if(nowP==totalPages){%>
    		<ul class="paginList">
	        <li class="paginItem"><a href="CarListServlet?nowPage=1">首页</a></li>
	        <li class="paginItem"><a href="CarListServlet?nowPage=<%=nowP-1%>">上页</a></li>
