...
<body style="background:url(images/topbg.gif) repeat-x;">
    ...
    <div class="topleft">
    <a href="main2.jsp" target="_parent"><img src="images/logo.png" title="系统首页" /></a>
    </div>
    ...
    <li><a href="#">修改信息</a></li>
    <li><a href="shouye.jsp" target="_parent">退出</a></li>
    </ul>
    ...
    String name=request.getAttribute("top2").toString();
