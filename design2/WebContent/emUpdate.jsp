...
<body>
    ...
    <form name="frm" method="post">
	    ...
	    <li><label>员工姓名</label><input name="ename" type="text" class="dfinput" value="<%=name%>"/><i>姓名不能超过五个字符</i></li>
	    <li><label>员工密码：</label><input name="epwd" type="password" class="dfinput" value="<%=pwd%>"/><i>密码长度不能超过十个</i></li>
	    ...
	    <li><label>员工年龄：</label><input name="eage" type="text" class="dfinput" value="<%=age%>" /></li>
	    <li><label>员工电话：</label><input name="etel" type="text" class="dfinput" value="<%=tel%>"></li>
	    <li><label>员工身份证：</label><input name="eidcard" type="text" class="dfinput" value="<%=idcard%>"></li>
...
<script>
	function fun(){
		document.frm.action="EmUpdateServlet";
		document.frm.submit();
	}
</script>
