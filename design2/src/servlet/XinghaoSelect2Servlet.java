...
/**
 * Servlet implementation class XinghaoSelect2Servlet
 */
public class XinghaoSelect2Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public XinghaoSelect2Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("xinghaoSelect2.jsp").forward(request, response);
	}
